...
- Add workspace reference to `@tsienArron/eslint-ts` and its peer dependencies:

  ```sh
  pnpm add -w @tsienArron/eslint-ts eslint
  ```
...
- Add eslint configuration file:
  ...
  module.exports = require('@tsienArron/eslint-ts');
  ```
