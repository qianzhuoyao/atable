...
- Add workspace reference to `@tsienArron/prettier` and its peer dependencies:

  ```sh
  pnpm add -w @tsienArron/prettier prettier
  ```
...
- Add prettier configuration file:
  ...
  module.exports = require('@tsienArron/prettier');
  ```
