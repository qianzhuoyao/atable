...
- Add workspace reference to `@tsienArron/remark` and its peer dependencies:

  ```sh
  pnpm add -w @tsienArron/remark remark remark-cli
  ```
...
- Add remark configuration file:
  ...
  export { default } from '@tsienArron/remark';
  ```
